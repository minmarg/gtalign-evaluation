...
(ls -1 fatcat | grep -E .out | xargs -i -P 40 perl -e '
  ...
  close(F);close(Q);') >fatcat__scope20840__processed.out 2>fatcat__scope20840__processed.err
...
(ls -1 deepalign | grep -E .out | xargs -i -P 40 perl -e '
  ...
  close(F);') >deepalign__scope20840__processed.out 2>deepalign__scope20840__processed.err
...
(ls -1 dali | grep -E .txt | xargs -i -P 40 perl -e '
  ...
  close(F);') >DALIv5__scope20840__processed.out 2>DALIv5__scope20840__processed.err
...
(ls -1 ${MYPROCDIR} | grep -E .out | xargs -i -P 40 perl -e '
  ...
  close(F);') >${MYPROCDIR}__scope20840__processed.out 2>${MYPROCDIR}__scope20840__processed.err
...
') >${MYPROCDIR}__scope20840__processed.out 2>${MYPROCDIR}__scope20840__processed.err
