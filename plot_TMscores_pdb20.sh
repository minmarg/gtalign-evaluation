...
GTA7_speed0_pre03="gtalign_14_speed0_prescore03_addss_s044__pdb20__processed.out"
GTA7_speed9_pre03="gtalign_14_speed9_prescore03_addss_s044__pdb20__processed.out"
GTA7_speed9_pre04="gtalign_14_speed9_prescore04_addss_s044__pdb20__processed.out"
GTA7_speed13_pre03="gtalign_14_speed13_prescore03_addss_s044__pdb20__processed.out"
GTA7_speed13_pre04="gtalign_14_speed13_prescore04_addss_s044__pdb20__processed.out"
GTA7_speed13_pre03_sim15="gtalign_14_speed13_prescore03_presim15_addss_s03__pdb20__processed.out"
TMalign="tmalign__pdb20__processed.out"
TMalignFast="tmalign_fast__pdb20__processed.out"
DeepAlign="deepalign__pdb20__processed.out"
DALI5="DALIv5__pdb20__processed.out"
Fatcat="fatcat__pdb20__processed.out"
FS_="foldseek_alntyp2__pdb20__processed.out"
FS1="foldseek_tmfast1__pdb20__processed.out"
FS0="foldseek_tmfast0__pdb20__processed.out"
## FUNCTIONS
function GetXYSum() {
  local file=$1
  local cnt=$2
...
if [ "$SORT" == "besttm" ]; then
  ...
  GTA7_speed0_pre03_tm_dat=("GTalign --speed=0" $(GetXYSum "../$GTA7_speed0_pre03" $NN 14 14 14 D) 872.638)
  GTA7_speed9_pre03_tm_dat=("GTalign --speed=9 (def)" $(GetXYSum "../$GTA7_speed9_pre03" $NN 14 14 14 D) 223.880)
  GTA7_speed9_pre04_tm_dat=("GTalign --speed=9 --pre-score=0.4" $(GetXYSum "../$GTA7_speed9_pre04" $NN 14 14 14 D) 113.496)
  GTA7_speed13_pre03_tm_dat=("GTalign --speed=13" $(GetXYSum "../$GTA7_speed13_pre03" $NN 14 14 14 D) 104.583)
  GTA7_speed13_pre04_tm_dat=("GTalign --speed=13 --pre-score=0.4" $(GetXYSum "../$GTA7_speed13_pre04" $NN 14 14 14 D) 69.912)
  GTA7_speed13_pre03_sim15_tm_dat=("GTalign --speed=13 --pre-similarity=15" $(GetXYSum "../$GTA7_speed13_pre03_sim15" $NN 14 14 14 D) 46.333)

  TMalign_tm_dat=("TM-align" $(GetXYSum "../$TMalign" $NN 7 7 7 D) 28504.830)
  TMalign_fast_tm_dat=("TM-align -fast" $(GetXYSum "../$TMalignFast" $NN 7 7 7 D) 4826.490)
  Deepalign_tm_dat=("DeepAlign" $(GetXYSum "../$DeepAlign" $NN 11 11 11 D) 187205.012)
  DALI5_tm_dat=("DALI" $(GetXYSum "../$DALI5" $NN 12 12 12 D) 49194.380)
  Fatcat_tm_dat=("FATCAT" $(GetXYSum "../$Fatcat" $NN 11 11 11 D) 102395.700)
  FS__tm_dat=("Foldseek" $(GetXYSum "../$FS_" $NN 13 13 13 D) 19.313)
  FS1_tm_dat=("Foldseek --tmalign-fast 1" $(GetXYSum "../$FS1" $NN 13 13 13 D) 203.336)
  FS0_tm_dat=("Foldseek --tmalign-fast 0" $(GetXYSum "../$FS0" $NN 13 13 13 D) 1156.003)
  ...
  ## sort by tm-score obtained by tm-align
  GTA7_speed0_pre03_tm_dat=("GTalign --speed=0" $(GetXYSum "../$GTA7_speed0_pre03" $NN 10 10 10 D) 872.638)
  GTA7_speed9_pre03_tm_dat=("GTalign --speed=9 (def)" $(GetXYSum "../$GTA7_speed9_pre03" $NN 10 10 10 D) 223.880)
  GTA7_speed9_pre04_tm_dat=("GTalign --speed=9 --pre-score=0.4" $(GetXYSum "../$GTA7_speed9_pre04" $NN 10 10 10 D) 113.496)
  GTA7_speed13_pre03_tm_dat=("GTalign --speed=13" $(GetXYSum "../$GTA7_speed13_pre03" $NN 10 10 10 D) 104.583)
  GTA7_speed13_pre04_tm_dat=("GTalign --speed=13 --pre-score=0.4" $(GetXYSum "../$GTA7_speed13_pre04" $NN 10 10 10 D) 69.912)
  GTA7_speed13_pre03_sim15_tm_dat=("GTalign --speed=13 --pre-similarity=15" $(GetXYSum "../$GTA7_speed13_pre03_sim15" $NN 10 10 10 D) 46.333)

  TMalign_tm_dat=("TM-align" $(GetXYSum "../$TMalign" $NN 3 3 3 D) 28504.830)
  TMalign_fast_tm_dat=("TM-align -fast" $(GetXYSum "../$TMalignFast" $NN 3 3 3 D) 4826.490)
  Deepalign_tm_dat=("DeepAlign" $(GetXYSum "../$DeepAlign" $NN 7 7 7 D) 187205.012)
  DALI5_tm_dat=("DALI" $(GetXYSum "../$DALI5" $NN 8 8 8 D) 49194.380)
  Fatcat_tm_dat=("FATCAT" $(GetXYSum "../$Fatcat" $NN 7 7 7 D) 102395.700)
  FS__tm_dat=("Foldseek" $(GetXYSum "../$FS_" $NN 9 9 9 D) 19.313)
  FS1_tm_dat=("Foldseek --tmalign-fast 1" $(GetXYSum "../$FS1" $NN 9 9 9 D) 203.336)
  FS0_tm_dat=("Foldseek --tmalign-fast 0" $(GetXYSum "../$FS0" $NN 9 9 9 D) 1156.003)
