...
CFRIGNORE=0 #1 ##ignore matches across related fold groups
PR=0 ##P-R plot; Recall1 when 0
...
function GetXYRec1() {
  ...
  local fields=$3
  local fieldk=$4
  FLDV=$fieldv FLDS=$fields FLDK=$fieldk perl -e '
    while(<>){
      @a=split(/\s+/);
      push @ss1, $a[$ENV{FLDS}-1];
      push @ss2, $a[$ENV{FLDS}];
      push @sk, $a[$ENV{FLDK}];
      push @sv, $a[$ENV{FLDV}];
    } 
    ...
    for($i=$c=0;$i<=$#sndx;$i++){
      $effsz=$ss2[$sndx[$i]] - 1;
      $effsz=$ss2[$sndx[$i]] - $ss1[$sndx[$i]] if($ENV{FLDS}>6);
      if($effsz > 0) {
        do{$y.=",";$x.=","} if $c;
        $y.=sprintf("%.4f",$sv[$sndx[$i]]); 
        $x.=sprintf("%.4f",(++$c) / $sk[$sndx[$i]]);
      }
    } 
    $y.=")"; $x.=")"; 
    print $x, " ", $y' $file
...
GTA7_speed0_pre03_fam_r1=("GTalign --speed=0" $(GetXYRec1 "../$GTA7_speed0_pre03" 2 6 9))
GTA7_speed0_pre03_sfam_r1=("GTalign --speed=0" $(GetXYRec1 "../$GTA7_speed0_pre03" 3 7 10))
GTA7_speed0_pre03_fold_r1=("GTalign --speed=0" $(GetXYRec1 "../$GTA7_speed0_pre03" 4 8 11))

GTA7_speed9_pre03_fam_r1=("GTalign --speed=9 (def)" $(GetXYRec1 "../$GTA7_speed9_pre03" 2 6 9))
GTA7_speed9_pre03_sfam_r1=("GTalign --speed=9 (def)" $(GetXYRec1 "../$GTA7_speed9_pre03" 3 7 10))
GTA7_speed9_pre03_fold_r1=("GTalign --speed=9 (def)" $(GetXYRec1 "../$GTA7_speed9_pre03" 4 8 11))

GTA7_speed9_pre04_fam_r1=("GTalign --speed=9 --pre-score=0.4" $(GetXYRec1 "../$GTA7_speed9_pre04" 2 6 9))
GTA7_speed9_pre04_sfam_r1=("GTalign --speed=9 --pre-score=0.4" $(GetXYRec1 "../$GTA7_speed9_pre04" 3 7 10))
GTA7_speed9_pre04_fold_r1=("GTalign --speed=9 --pre-score=0.4" $(GetXYRec1 "../$GTA7_speed9_pre04" 4 8 11))

GTA7_speed13_pre03_fam_r1=("GTalign --speed=13" $(GetXYRec1 "../$GTA7_speed13_pre03" 2 6 9))
GTA7_speed13_pre03_sfam_r1=("GTalign --speed=13" $(GetXYRec1 "../$GTA7_speed13_pre03" 3 7 10))
GTA7_speed13_pre03_fold_r1=("GTalign --speed=13" $(GetXYRec1 "../$GTA7_speed13_pre03" 4 8 11))

GTA7_speed13_pre04_fam_r1=("GTalign --speed=13 --pre-score=0.4" $(GetXYRec1 "../$GTA7_speed13_pre04" 2 6 9))
GTA7_speed13_pre04_sfam_r1=("GTalign --speed=13 --pre-score=0.4" $(GetXYRec1 "../$GTA7_speed13_pre04" 3 7 10))
GTA7_speed13_pre04_fold_r1=("GTalign --speed=13 --pre-score=0.4" $(GetXYRec1 "../$GTA7_speed13_pre04" 4 8 11))

GTA7_speed13_pre03_sim15_fam_r1=("GTalign --speed=13 --pre-similarity=15" $(GetXYRec1 "../$GTA7_speed13_pre03_sim15" 2 6 9))
GTA7_speed13_pre03_sim15_sfam_r1=("GTalign --speed=13 --pre-similarity=15" $(GetXYRec1 "../$GTA7_speed13_pre03_sim15" 3 7 10))
GTA7_speed13_pre03_sim15_fold_r1=("GTalign --speed=13 --pre-similarity=15" $(GetXYRec1 "../$GTA7_speed13_pre03_sim15" 4 8 11))

TMalign_fam_r1=("TM-align" $(GetXYRec1 "../$TMalign" 2 6 9))
TMalign_sfam_r1=("TM-align" $(GetXYRec1 "../$TMalign" 3 7 10))
TMalign_fold_r1=("TM-align" $(GetXYRec1 "../$TMalign" 4 8 11))

TMalign_fast_fam_r1=("TM-align -fast" $(GetXYRec1 "../$TMalignFast" 2 6 9))
TMalign_fast_sfam_r1=("TM-align -fast" $(GetXYRec1 "../$TMalignFast" 3 7 10))
TMalign_fast_fold_r1=("TM-align -fast" $(GetXYRec1 "../$TMalignFast" 4 8 11))

Deepalign_fam_r1=("DeepAlign" $(GetXYRec1 "../$DeepAlign" 2 6 9))
Deepalign_sfam_r1=("DeepAlign" $(GetXYRec1 "../$DeepAlign" 3 7 10))
Deepalign_fold_r1=("DeepAlign" $(GetXYRec1 "../$DeepAlign" 4 8 11))

DALI5_fam_r1=("DALI" $(GetXYRec1 "../$DALI5" 2 6 9))
DALI5_sfam_r1=("DALI" $(GetXYRec1 "../$DALI5" 3 7 10))
DALI5_fold_r1=("DALI" $(GetXYRec1 "../$DALI5" 4 8 11))

Fatcat_fam_r1=("FATCAT" $(GetXYRec1 "../$Fatcat" 2 6 9))
Fatcat_sfam_r1=("FATCAT" $(GetXYRec1 "../$Fatcat" 3 7 10))
Fatcat_fold_r1=("FATCAT" $(GetXYRec1 "../$Fatcat" 4 8 11))

FS__fam_r1=("Foldseek" $(GetXYRec1 "../$FS_" 2 6 9))
FS__sfam_r1=("Foldseek" $(GetXYRec1 "../$FS_" 3 7 10))
FS__fold_r1=("Foldseek" $(GetXYRec1 "../$FS_" 4 8 11))

FS1_fam_r1=("Foldseek --tmalign-fast 1" $(GetXYRec1 "../$FS1" 2 6 9))
FS1_sfam_r1=("Foldseek --tmalign-fast 1" $(GetXYRec1 "../$FS1" 3 7 10))
FS1_fold_r1=("Foldseek --tmalign-fast 1" $(GetXYRec1 "../$FS1" 4 8 11))

FS0_fam_r1=("Foldseek --tmalign-fast 0" $(GetXYRec1 "../$FS0" 2 6 9))
FS0_sfam_r1=("Foldseek --tmalign-fast 0" $(GetXYRec1 "../$FS0" 3 7 10))
FS0_fold_r1=("Foldseek --tmalign-fast 0" $(GetXYRec1 "../$FS0" 4 8 11))
...
P21 <- ggplot(dat, aes(x = x, y = y, colour = group, linetype = group)) +
  ...
  labs(x='Effective fraction of queries', y='Sensitivity up to 1st FP') +
