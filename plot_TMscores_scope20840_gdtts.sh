...
GTA7_speed0_pre03="gtalign_14_speed0_prescore03_addss_s044__scope20840__processed_gdtts.out"
GTA7_speed9_pre03="gtalign_14_speed9_prescore03_addss_s044__scope20840__processed_gdtts.out"
GTA7_speed9_pre04="gtalign_14_speed9_prescore04_addss_s044__scope20840__processed_gdtts.out"
GTA7_speed13_pre03="gtalign_14_speed13_prescore03_addss_s044__scope20840__processed_gdtts.out"
GTA7_speed13_pre04="gtalign_14_speed13_prescore04_addss_s044__scope20840__processed_gdtts.out"
GTA7_speed13_pre03_sim15="gtalign_14_speed13_prescore03_presim15_addss_s03__scope20840__processed_gdtts.out"
TMalign="tmalign__scope20840__processed_gdtts.out"
TMalignFast="tmalign_fast__scope20840__processed_gdtts.out"
DeepAlign="deepalign__scope20840__processed_gdtts.out"
DALI5="DALIv5__scope20840__processed_gdtts.out"
Fatcat="fatcat__scope20840__processed_gdtts.out"
FS_="foldseek_alntyp2__scope20840__processed_gdtts.out"
FS1="foldseek_tmfast1__scope20840__processed_gdtts.out"
FS0="foldseek_tmfast0__scope20840__processed_gdtts.out"
## FUNCTIONS
function GetXYSum() {
  local file=$1
  local cnt=$2
...
NN=750000
GTA7_speed0_pre03_dat=("GTalign --speed=0" $(GetXYSum "../$GTA7_speed0_pre03" $NN 8 8 10 D))
GTA7_speed9_pre03_dat=("GTalign --speed=9 (def)" $(GetXYSum "../$GTA7_speed9_pre03" $NN 8 8 10 D))
GTA7_speed9_pre04_dat=("GTalign --speed=9 --pre-score=0.4" $(GetXYSum "../$GTA7_speed9_pre04" $NN 8 8 10 D))
GTA7_speed13_pre03_dat=("GTalign --speed=13" $(GetXYSum "../$GTA7_speed13_pre03" $NN 8 8 10 D))
GTA7_speed13_pre04_dat=("GTalign --speed=13 --pre-score=0.4" $(GetXYSum "../$GTA7_speed13_pre04" $NN 8 8 10 D))
GTA7_speed13_pre03_sim15_dat=("GTalign --speed=13 --pre-similarity=15" $(GetXYSum "../$GTA7_speed13_pre03_sim15" $NN 8 8 10 D))

TMalign_dat=("TM-align" $(GetXYSum "../$TMalign" $NN 7 7 9 D))
TMalign_fast_dat=("TM-align -fast" $(GetXYSum "../$TMalignFast" $NN 7 7 9 D))
Deepalign_dat=("DeepAlign" $(GetXYSum "../$DeepAlign" $NN 5 5 7 D)) ##3 3 13 D)) ##:by deepscore
DALI5_dat=("DALI" $(GetXYSum "../$DALI5" $NN 6 6 8 D))
Fatcat_dat=("FATCAT" $(GetXYSum "../$Fatcat" $NN 5 5 7 A))
FS__dat=("Foldseek" $(GetXYSum "../$FS_" $NN 5 7 9 D)) ##3 3 9 A)) ##:by Evalue
FS1_dat=("Foldseek --tmalign-fast 1" $(GetXYSum "../$FS1" $NN 5 7 9 D))
FS0_dat=("Foldseek --tmalign-fast 0" $(GetXYSum "../$FS0" $NN 5 7 9 D))
...
sprintf('%-40s %.4f %.4f','${GTA7_speed0_pre03_dat[0]}',${GTA7_speed0_pre03_dat[4]},${GTA7_speed0_pre03_dat[5]});
sprintf('%-40s %.4f %.4f','${GTA7_speed9_pre03_dat[0]}',${GTA7_speed9_pre03_dat[4]},${GTA7_speed9_pre03_dat[5]});
sprintf('%-40s %.4f %.4f','${GTA7_speed9_pre04_dat[0]}',${GTA7_speed9_pre04_dat[4]},${GTA7_speed9_pre04_dat[5]});
sprintf('%-40s %.4f %.4f','${GTA7_speed13_pre03_dat[0]}',${GTA7_speed13_pre03_dat[4]},${GTA7_speed13_pre03_dat[5]});
sprintf('%-40s %.4f %.4f','${GTA7_speed13_pre04_dat[0]}',${GTA7_speed13_pre04_dat[4]},${GTA7_speed13_pre04_dat[5]});
sprintf('%-40s %.4f %.4f','${GTA7_speed13_pre03_sim15_dat[0]}',${GTA7_speed13_pre03_sim15_dat[4]},${GTA7_speed13_pre03_sim15_dat[5]});
sprintf('%-40s %.4f %.4f','${TMalign_dat[0]}',${TMalign_dat[4]},${TMalign_dat[5]});
sprintf('%-40s %.4f %.4f','${TMalign_fast_dat[0]}',${TMalign_fast_dat[4]},${TMalign_fast_dat[5]});
sprintf('%-40s %.4f %.4f','${Deepalign_dat[0]}',${Deepalign_dat[4]},${Deepalign_dat[5]});
sprintf('%-40s %.4f %.4f','${DALI5_dat[0]}',${DALI5_dat[4]},${DALI5_dat[5]});
sprintf('%-40s %.4f %.4f','${Fatcat_dat[0]}',${Fatcat_dat[4]},${Fatcat_dat[5]});
sprintf('%-40s %.4f %.4f','${FS__dat[0]}',${FS__dat[4]},${FS__dat[5]});
sprintf('%-40s %.4f %.4f','${FS1_dat[0]}',${FS1_dat[4]},${FS1_dat[5]});
sprintf('%-40s %.4f %.4f','${FS0_dat[0]}',${FS0_dat[4]},${FS0_dat[5]});
